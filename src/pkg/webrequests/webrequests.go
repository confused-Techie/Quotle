...
func HomeHandler(w http.ResponseWriter, r *http.Request) {
	...
	data := models.PageTemplate{
		...
		JS:             []string{"/js/home.js?cache_buster=" + viper.GetString("env_variables.VERSION"), "https://storage.googleapis.com/quotle-games/" + strconv.Itoa(cycledata.GlobalGameID) + "/answer.js"},
